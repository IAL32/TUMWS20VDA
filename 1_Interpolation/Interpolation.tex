...
\begin{align*}
    f(\alpha, \beta) = & f_{ij} \cdot (1 - \alpha)(1 - \beta) + \\
                       & f_{i+i, j} \cdot \alpha (1 - \beta) +  \\
                       & f_{i, j+1} \cdot (1 - \alpha) \beta +  \\
                       & f_{i+1, j+1} \cdot \alpha \beta
\end{align*}
...
\begin{center}
    \begin{tikzpicture}
        ...
        \coordinate (3) at (4,4);
        \coordinate (4) at (0,4);
        \fill (1) circle (1pt) node [left] {$f_{ij}$};
        \fill (2) circle (1pt) node [right] {$f_{i + 1, j}$};
        \fill (3) circle (1pt) node [above] {$f_{i+1, j+1}$};
        \fill (4) circle (1pt) node [above] {$f_{i, j+1}$};
        ...
        \node[text width=15mm] at (0.8, 3) {$\alpha \cdot (1 - \beta)$};
        \node[text width=15mm] at (1, 1) {$\alpha \cdot \beta$};
        \node[text width=20mm] at (2.8, 3) {$(1 - \alpha) \cdot (1 - \beta)$};
        \node[text width=15mm] at (3, 1) {$(1 - \alpha) \cdot \beta$};
